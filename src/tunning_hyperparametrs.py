...
def get_hiperparametrs_svm(X_train, y_train, parameters=None):
...
def get_hiperparametrs_knn(X_train, y_train, parameters=None):
...
def get_hiperparametrs_gb(X_train, y_train, parameters=None):
